...
// Styles and icons
import "../assets/styles/servers.css";
...
const Servers = () => {
  ...
  // getting servers data from firebase
  ...
  return (
    <div className="servers">
      <div
        className="server homepage"
        onClick={() => {
          selectServer(null);
        }}
      >
        <svg
          className="homeIcon-FuNwkv"
          aria-hidden="false"
          width="28"
          height="20"
          viewBox="0 0 28 20"
      ...
      <div className="server" onClick={open}>
        <AddSharpIcon fontSize="large" />
      </div>

      {openModal && <AddServerModal handelOnClick={close} />}
    </div>
  );
};
